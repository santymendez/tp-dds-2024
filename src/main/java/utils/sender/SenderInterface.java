...
public interface SenderInterface {
  ...
  /*
  se me ocurrio como que todos debian cumplir una misma interfaz asi
  podiamos instanciarlos del tipo:
  ...
  destinatario que se instancie con los datos que tenga y lugo en cada enviar se usan los
